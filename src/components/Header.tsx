    ...
    <header className="overflow-hidden">
      <nav className="flex flex-wrap justify-between min-w-full">
        <div className="flex flex-row items-center">
          ...
          <p className="text-xl font-bold mx-1 md:text-3xl">{title} 
        ...
        <div className={`${isMenuOpen ? 'w-full opacity-100 bg-[#e1e3e3]' : 'w-[200%] opacity-0 md:bg-none md:opacity-100'}  z-10 size-full absolute -top-5 md:top-0 pt-15 md:pt-0 left-0 md:relative md:w-auto md:flex text-center text-bold mt-5 md:mt-0  transition-all duration-700 ease-in-out transform `}>
          <a href="#" className="block md:inline-block hover:text-sky-700 px-3 py-3 hover:underline underline-offset-4 text-lg">
            Curriculum
          </a>
          <a href="#" className="block md:inline-block hover:hover:text-sky-700 px-3 py-3 hover:underline underline-offset-4 text-lg">
            Projects
          </a>
          <a href="#" className="block md:inline-block hover:hover:text-sky-700 px-3 py-3 hover:underline underline-offset-4 text-lg">
            Contact

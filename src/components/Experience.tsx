export default function Experience({translation}) {
  return (
    <section id="experience" className="flex flex-col justify-center md:p-4 gap-4">
      <h2 className="text-2xl font-bold my-6 ">{translation.curriculum.title}</h2>
      <a href={`/portfolio-laura/assets/LauraLopez_${translation.home.current}.pdf`} download="CV_LauraLopez.pdf" className="btn-download flex gap-3 mb-5 font-semibold text-[#22668D] hover:text-[#FFCC70]">
